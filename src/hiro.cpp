...
namespace hiro
{
   ...
   void HIRO::set_timelimit(double _timelimit)
   {
      timelimit = _timelimit;
   }
   ...
   vector<vector<double> > HIRO::get_c()
   {
      return c;
   }
   ...
   double HIRO::solve_master(bool relax)
   {
      int K = x.size();
   ...
   double HIRO::solve_master_decomp(double lowerbound, bool relax)
   {
      int K = x.size();
   ...
   double HIRO::solve_master_alternateheuristic()
   {
      int K = x.size();
      bool repeat = true;
   ...
   double HIRO::build_decomp_sub(const IloEnv env, IloModel& model, IloCplex& cplex, IloObjective& objective,
   ...
   double HIRO::solve_decomp_sub(IloEnv& env, IloModel& model, IloCplex& cplex, IloObjective& objective,
   ...
   double HIRO::execute_column_generation(IloEnv& masterenv, IloModel& master, IloCplex& cpxmaster, IloEnv& env,
